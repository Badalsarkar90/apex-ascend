...
const navLinks: NavLink[] = [
  ...
  { label: "About", href: "/about" },
  {
    ...
    submenu: [
      ...
      { label: "Smash Mortgage", href: "/real-estate/smash-mortgage" },
    ],
  },
  {
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between h-20">
          {/* Logo */}
          <Link to="/" className="font-display text-xl font-bold tracking-tight flex-shrink-0">
            <span className="gold-gradient-text">ADAM</span>
            <span className={`ml-1 ${logoSecondary}`}>COHEN</span>
          </Link>
          ...
          >
            <div className="flex flex-col gap-6 pb-12">
                      ...
                      {link.href ? (
                        <Link
                          ...
                          className={`text-2xl font-display font-bold transition-colors ${
                            isActive(link, location.pathname) ? mobileLinkActive : mobileLinkBase
                          }`}
                        >
                          {link.label}
                        </Link>
              ...
              <div className={`pt-6 mt-2 border-t ${mobileDivider}`}>
                <Link to="/contact" className="hero-btn w-full text-center block py-4 text-sm">
