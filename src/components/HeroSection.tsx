...
const slides = [
  {
    ...
    title2: "PARTYING &",
    title3: "NETWORKING",
    title4: "WITH 7, 8, & 9-FIGURE ENTREPRENEURS",
    location: "IN LOS ANGELES",
    date: "THU & FRI, APRIL 9TH & 10TH",
    theme: "red",
    mask: "none"
  },
  {
    ...
    title4: "HIGH NET WORTH SHORT GUIDE.",
    theme: "yellow",
    mask: "hexagon"
  },
  {
  ...
  },
  {
    ...
    title4: "GENERATED OVER $700 MILLION",
    theme: "black",
    mask: "arrow-right"
  }
];
      ...
      <div className="flex h-full">
        {slides.map((slide, index) => (
          <div key={slide.id} className="relative flex-[0_0_100%] min-w-0 h-full">
            {/* Background */}
            <div className={`absolute inset-0 ${slide.bg.startsWith('bg-') ? slide.bg : ''}`}>
              {!slide.bg.startsWith('bg-') && (
                <img src={slide.bg} alt="" className="w-full h-full object-cover opacity-40 mix-blend-overlay" />
              )}
            </div>
