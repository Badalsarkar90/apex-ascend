...
import { DollarSign, TrendingUp, Home, ArrowRight, CheckCircle2 } from "lucide-react";
...
const services = [
  {
    ...
    features: [
      ...
      "Bridge, fix-and-flip & new construction",
    ],
  },
  {
    id: "private-equity",
    ...
    features: [
      "Equity positions from $500K",
      "Joint venture structures",
      "Multifamily, retail & mixed-use",
      "Deal sourcing & underwriting support",
  ...
  },
  {
    ...
    title: "Smash Mortgage",
    tagline: "Crush Your Mortgage. Build Real Wealth.",
    description:
      "Our proprietary mortgage acceleration program helps homeowners and investors pay off debt faster, reduce interest paid, and redirect cash flow into wealth-building assets.",
    image: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1200&q=80&fit=crop",
    features: [
      "Personalized payoff acceleration plan",
      "Interest savings analysis",
      "Bi-weekly payment strategies",
      "Debt stacking methodology",
  ...
  <PageTransition>
    ...
    <section className="section-padding">
      <div className="max-w-4xl mx-auto text-center glass-card p-12 md:p-20 border border-primary/20">
        ...
        <Link to="/contact" className="hero-btn inline-block">Book a Strategy Call</Link>
      </div>
    </section>
  </PageTransition>
);
