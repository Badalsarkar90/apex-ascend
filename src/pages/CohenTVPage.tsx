...
import { Play, Mic, Youtube, Headphones, ArrowRight } from "lucide-react";

const episodes = [
  {
    number: "001",
    title: "From Zero to 7 Figures — My Real Story",
    description: "The unfiltered truth about my early failures, the pivots that changed everything, and the mindset shifts that made wealth inevitable.",
    duration: "1h 12m",
    tag: "Mindset",
  },
  {
    number: "002",
    title: "Real Estate Is Not What They Told You",
    description: "Breaking down the myths around real estate investing and revealing the strategies that actually build long-term wealth without gambling your future.",
    duration: "58m",
    tag: "Real Estate",
  },
  {
    ...
    description: "Systems, people, and processes that allow your business to scale beyond your personal bandwidth — the framework I use with all my portfolio companies.",
    duration: "1h 4m",
    tag: "Business",
  },
  {
    ...
    description: "How to build authority, generate leads, and create an audience that trusts you — without dancing on TikTok or burning out.",
    duration: "47m",
    tag: "Marketing",
  },
  {
    ...
    description: "How to attract investors, structure deals, and raise money even when the economy is uncertain. Lessons from $500M in transactions.",
    duration: "1h 20m",
    tag: "Finance",
  },
  {
    ...
    description: "The real ROI of high-level masterminds, accountability groups, and mentorship — and how to choose the right room to be in.",
    duration: "52m",
    tag: "Community",
  },
];
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {episodes.map((ep, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="glass-card p-7 group cursor-pointer hover:border-primary/30 transition-all duration-500"
            >
              <div className="flex items-start justify-between mb-4">
                <span className="text-xs font-bold tracking-[0.2em] text-primary/60 font-mono">EP.{ep.number}</span>
              ...
              <div className="mt-5 flex items-center gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">
                <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center">
                  <Play className="w-3.5 h-3.5 text-primary-foreground fill-current" />
                </div>
                <span className="text-xs font-semibold text-primary tracking-wide">Play Episode</span>
              </div>
            </motion.div>
          ))}
        </div>
