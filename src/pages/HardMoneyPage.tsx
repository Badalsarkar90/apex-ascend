...
import {
  ...
  TrendingUp, Shield, Zap, FileText, Star
} from "lucide-react";
    ...
    <section className="relative min-h-[60vh] flex items-end pb-20 px-6 overflow-hidden pt-32">
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        ...
        >
          ...
          <Link to="/real-estate" className="hero-btn-outline inline-flex items-center gap-2">
    ...
    <section className="section-padding">
      <div className="max-w-4xl mx-auto text-center glass-card p-12 md:p-20 border border-primary/20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link to="/real-estate/private-equity" className="hero-btn-outline inline-flex items-center gap-2">
